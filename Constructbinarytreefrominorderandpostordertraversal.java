 ...
 * 6. The number of nodes in the right subtree is `inorderEnd - rootIndex`.
 * 7. Recursively build the left subtree: `root.left = buildTreeHelper(inorder, postorder, inorderStart, rootIndex - 1, postorderStart, postorderStart + (rootIndex - inorderStart) - 1, inorderMap)`.
 * 8. Recursively build the right subtree: `root.right = buildTreeHelper(inorder, postorder, rootIndex + 1, inorderEnd, postorderStart + (rootIndex - inorderStart), postorderEnd - 1, inorderMap)`.
